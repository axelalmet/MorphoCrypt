function Residuals = SelfPointContactRegionThreePointBCs(Ml, Mr, modelParams)
...
Residuals = [Ml(1, 1), ... % S(0) = 0
             ...
             Ml(9, 2) - Mr(9, 1), ... % continuity in sc
             Ml(1, 3) - Mr(1, 2), ... continuity in S
             Ml(2, 3) - Mr(2, 2), ... continuity in x
             Ml(3, 3) - Mr(3, 2), ... continuity in y
             Ml(5, 3) - Mr(5, 2), ... continuity in ny
             Ml(6, 3) - Mr(6, 2), ... continuity in theta
             Ml(7, 3) - Mr(7, 2), ... continuity in m
             Ml(8, 3) - Mr(8, 2), ... continuity in sc
             Ml(9, 3) - Mr(9, 2), ... continuity in sr
             Mr(1, 3) - L, ... % S(L) = L
             Mr(2, 3) - 0.5, ... % x(L) = 0.5
             Mr(3, 3) - y0, ... % y(L) = y0
             Mr(6, 3)];  % theta(L) = 0
