function Odes = RemodellingFoundationNormalPressureContactRegionThreePointOdes(x, M, region, MOld, modelParams)
...
xOld = MOld.x([1:contIndex, (contIndex + 2):(contIndexTwo), ...
            (contIndexTwo + 2):end]);
...
Py = modelParams.Py;
    ...
    function dMdS = ContactEqns(x, M, region)
        ...
        if (length(gamma) > 1)
            gammaOld = gamma([1:contIndex, (contIndex + 2):(contIndexTwo), ...
            (contIndexTwo + 2):end]);
            gamma = interp1(xOld, gammaOld, x);
        end
        
        if (length(Eb) > 1)
            EbOld = Eb([1:contIndex, (contIndex + 2):(contIndexTwo), ...
            (contIndexTwo + 2):end]);
            Eb = interp1(xOld, EbOld, x);
        end
        
        if (length(Px) > 1)
            PxOld = Px([1:contIndex, (contIndex + 2):(contIndexTwo), ...
            (contIndexTwo + 2):end]);
            Px = interp1(xOld, PxOld, x);
        end
        
        if (length(Py) > 1)
            PyOld = Py([1:contIndex, (contIndex + 2):(contIndexTwo), ...
            (contIndexTwo + 2):end]);
        ...
        dMdS = [dSdS; dxdS; dydS; dFdS; dGdS; dthetadS; dmdS; dscdS; dAdS; dpCdS; dsrdS];
