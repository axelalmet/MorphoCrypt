...
solOptions = odeset('RelTol', 1e-12, 'AbsTol', 1e-12, 'Vectorized', 'On');
...
% %%
% solToSave = [Sols{end}(2,:); parameters.currentArcLength; Sols{end}(3,:); Sols{end}(4,:);...
%     Sols{end}(7,:); Sols{end}(8,:).*parameters.gamma]';
% 
% csvwrite('~/Documents/MorphoCrypt/Mathematica/Solutions/homeostaticwntbasedsol.csv', solToSave);
...
parameters.gamma = gammaOld(2:end);
...
KValues = 0:200:4000;
KValueNames = {'0', '200', '400', '600', '800', '1000', '1200', '1400', '1600', '1800', ...
...
%                 currentSol = GetBuckledInextensibleHomeostasisSolution(initialValues, solMesh, parameters, homeostaticSol, solOptions);
        
        savedSol = [0 currentSol.x; [n0; 0; 0; homeostaticSol.y(3,1); 0], currentSol.y; Sols{end}([3, 4, 7, 8],:)];
        outputDirectory = '../../../Solutions/BuckledRod/';
        outputValues = ['homeostasis_ext_Es_0p0048_L0_0p125_sigma_current_2w_linearmechano_mu_0p5_ns_-15_n0_-20_nu_',num2str(rho),'_k_',num2str(KValueNames{j})];
