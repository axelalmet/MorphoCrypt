...
for j = 1:length(stiffnessValues)
    ...
    for k = 1:length(muValues)
        ...
        outputValues = ['Es_1_nu_10_k_', stiffnessValueNames{j}, '_L0_0p125_current_sigma_2w_presloughing_T_5_clamped_bcs_linearmechano_mu_', ...
            muValueNames{k}, '_ns_-0p4'];
        % outputValues = 'Es_1_nu_10_k_1000_L0_0p125_sigma_init_2w_presloughing_T_5_clampedbcs_linearmechano_mu_10_ns_-0p4';
